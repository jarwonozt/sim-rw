...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Dokumentasi REST API SIM-RW (docs/issues/002-rest-api.md). Login lewat POST /api/v1/login untuk mendapatkan token, lalu kirim sebagai header Authorization: Bearer <token> di setiap request lain.',
    ],

    'ui' => [
        'title' => 'SIM-RW API Docs',
    ],
